...
To jest narzędzie do generowania reguł filtrowania pakietów z
względnie wysokopoziomowego języka opisu. Nie obsługuje wszystkich
zaawansowanych możliwości najnowszych filtrów pakietów, ale wspiera
przyzwoity podzbiór, wystarczający dla typowych stacji roboczych.

Aktualnie obsługuje tylko linuksowe iptables i ipchains. Obsługa Cisco
IOS jest zaczęta, ale nie kompletna. ipfilter Darrena Reeda jest
obsługiwany częściowo. Nie generuje optymalnych regułek i ma parę
ograniczeń, które powinny być usunięte, ale mimo to jest użytecznym
narzędziem.
